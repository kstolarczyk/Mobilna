...
namespace Core.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GrupaObiektowTypParametrow",
                columns: table => new
                {
                    GrupaObiektowId = table.Column<int>(nullable: false),
                    TypParametrowId = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrupaObiektowTypParametrow", x => new { x.GrupaObiektowId, x.TypParametrowId });
                    table.ForeignKey(
                        name: "FK_GrupaObiektowTypParametrow_GrupyObiektow_GrupaObiektowId",
                        column: x => x.GrupaObiektowId,
                        principalTable: "GrupyObiektow",
                        principalColumn: "GrupaObiektowId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GrupaObiektowTypParametrow_TypyParametrow_TypParametrowId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrupaObiektowTypParametrow_TypParametrowId",
                table: "GrupaObiektowTypParametrow",
